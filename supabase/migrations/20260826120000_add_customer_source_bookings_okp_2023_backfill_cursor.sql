...
create or replace function public.advance_customer_source_bookings_okp_2023_backfill_cursor_m2m(
...
declare
  ...
  v_sync_kind constant text := 'historical_backfill_2023';
...
begin
  ...
  perform pg_catalog.pg_advisory_xact_lock(
    pg_catalog.hashtextextended('customer_source_bookings_okp_historical_backfill_2023_cursor', 0)
  );
...
revoke all on function public.advance_customer_source_bookings_okp_2023_backfill_cursor_m2m(bigint, bigint)
  from public, anon, authenticated, service_role;

grant execute on function public.advance_customer_source_bookings_okp_2023_backfill_cursor_m2m(bigint, bigint)
  to service_role;
