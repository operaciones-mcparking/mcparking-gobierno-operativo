-- Fix UUID lookup when linking auth profiles to internal people records.
-- UUID lookup uses separate count and id selection to avoid unsupported UUID aggregates.
