...
const okpBookingsSyncPath = "/api/customer-window/okp/sync";
const mcpEapBookingsSyncPath = "/api/customer-window/mcp-eap/sync";
...
export async function middleware(request: NextRequest) {
  ...
  if (
    pathname === recoveryPurchasesSyncPath
    || pathname === okpBookingsSyncPath
    || pathname === mcpEapBookingsSyncPath
  ) {
